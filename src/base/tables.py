...
class ProfileTable(tables.Table):
  ...
  profile = tables.Column(visible=False)
  address = tables.Column(visible=False)
  photo = tables.Column(visible=False)

  first_name = tables.Column(accessor='profile', order_by='profile__first_name', verbose_name="Voornaam")
  #first_name = tables.LinkProfile(accessor='user.first_name', verbose_name="Voornaam")
  last_name = tables.Column(accessor='profile.last_name', verbose_name="Achternaam")
  email = tables.EmailColumn(accessor='profile.email', verbose_name="Email")
  ...
  favorite = tables.Column(accessor='profile', verbose_name=" ")
