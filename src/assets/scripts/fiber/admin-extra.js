...
window.CKEDITOR_CONFIG_EXTRA_ALLOWED_CONTENT = 'a[*]{*}(*);img[*]{*}(*);iframe[*];object[*];param[*];embed[*];div[*]{*}(*);small;i[*]{*}(*);p[*]{*}(*);td[*]{*}(*);u;center';

// Add some bootstrap grid styles
window.CKEDITOR_CONFIG_STYLES_SET = [
  { name: 'Normaal', element: 'span' },
  { name: 'Centreer', element: 'center' },
